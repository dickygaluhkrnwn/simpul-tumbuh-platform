  ...
  return (
    <main className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-primary-500 selection:text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-[60vw] h-[60vw] bg-primary-500/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10 my-12">
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-bold text-slate-900 font-uii tracking-tight mb-2">Buat Akun</h1>
            <p className="text-slate-500 font-medium">Bergabunglah dengan ekosistem inovasi UII.</p>
          </div>
          ...
          <div className="glass-panel bg-white/80 border border-slate-200/80 p-8 md:p-10 rounded-[2.5rem] shadow-xl backdrop-blur-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-accent-500/10 blur-3xl -mr-16 -mt-16 pointer-events-none" />
            ...
            {success ? (
              ...
              >
                <div className="w-20 h-20 bg-emerald-50 border border-emerald-100 rounded-full flex items-center justify-center mx-auto mb-6 text-emerald-500 shadow-sm">
                  <CheckCircle size={40} />
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Pendaftaran Berhasil!</h3>
                <p className="text-slate-500 font-medium">Menyelaraskan data Anda. Mohon tunggu...</p>
              </motion.div>
            ) : (
            ...
            <div className="mt-10 pt-8 border-t border-slate-200/80 text-center">
              <p className="text-slate-500 text-sm font-medium">
                Sudah memiliki akun?{" "}
                <Link href="/auth/login" className="text-primary-600 hover:text-primary-700 font-bold transition-all decoration-primary-500/30 underline-offset-4 hover:underline">
                  Masuk Disini
                </Link>
              </p>
            </div>
