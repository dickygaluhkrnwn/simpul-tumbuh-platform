...
export default function EditNewsPage() {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center py-40 gap-4">
      ...
      <p className="text-slate-500 font-bold uppercase tracking-widest text-xs animate-pulse">Menyiapkan Data...</p>
    </div>
  );
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 glass-panel bg-white/70 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 font-uii tracking-tight">Edit Artikel</h1>
          <p className="text-slate-500 font-medium text-sm mt-1">Perbarui konten dan informasi artikel ini.</p>
        </div>
      </div>
