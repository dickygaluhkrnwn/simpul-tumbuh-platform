...
export default function EditNewsPage() {
  ...
  if (loading) return <div className="p-10 text-center">Memuat artikel...</div>;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 font-uii">Edit Artikel</h1>
          <p className="text-slate-500 text-sm">Perbarui konten artikel ini.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
            ...
            <Button type="submit" className="w-full bg-rose-600 hover:bg-rose-700 gap-2" isLoading={saving}>
              <Save size={18} /> Update Artikel
            </Button>
          </div>
        </div>
