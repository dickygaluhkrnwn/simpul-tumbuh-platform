    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 glass-panel bg-white/70 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 font-uii tracking-tight">Buat Event Baru</h1>
          <p className="text-slate-500 font-medium text-sm mt-1">Lengkapi form di bawah untuk menambahkan kegiatan baru ke dalam ekosistem.</p>
        </div>
      </div>
          ...
          <div className="glass-panel bg-white/70 p-6 md:p-10 rounded-[2rem] border border-slate-200/80 shadow-sm space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input required name="title" placeholder="Contoh: Workshop Design Thinking" value={formData.title} onChange={handleChange} className="h-14 text-lg font-medium" />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select 
                    name="category" 
                    className="w-full h-11 px-3 rounded-xl border border-slate-200 bg-white/80 text-sm text-slate-900 focus:ring-2 focus:ring-primary-500 outline-none shadow-sm font-semibold"
