...
export default function LphPage() {
  return (
    <main className="min-h-screen relative font-sans transition-colors duration-400 flex flex-col selection:bg-primary-500 selection:text-white">
      <Header />
        ...
        <div className="container-tech relative z-10 flex justify-center">
          ...
          >
            ...
            <div className="relative glass-dark border border-white/10 p-10 md:p-20 rounded-[3rem] shadow-2xl text-center overflow-hidden group">
              ...
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary-500/30 rounded-full blur-2xl group-hover:bg-primary-500/40 transition-colors duration-500 pointer-events-none" />
              <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-indigo-500/20 rounded-full blur-2xl pointer-events-none" />
              ...
              <div className="relative mb-10 inline-flex items-center justify-center">
                <motion.div 
                  ...
                  className="absolute inset-0 text-primary-500/20 blur-[2px]"
                >
                  <Cpu size={120} />
                </motion.div>
                <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-primary-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-primary-500/50 relative z-10">
                  <Wrench size={40} className="text-white" />
                </div>
                <motion.div 
                  animate={{ scale: [1, 1.2, 1], opacity: [0.5, 1, 0.5] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="absolute -top-3 -right-3 text-accent-400 z-20"
                >
                  <Sparkles size={28} />
                </motion.div>
              </div>
              ...
              {/* Tombol Kembali */}
              <Link href="/">
                <Button size="lg" className="h-14 px-8 text-base font-bold bg-primary-600 hover:bg-primary-500 border-none text-white shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:shadow-[0_0_30px_rgba(59,130,246,0.6)] hover:scale-105 transition-all rounded-full">
