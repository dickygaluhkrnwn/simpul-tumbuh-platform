...
export default function Lp3hPage() {
  return (
    <main className="min-h-screen relative font-sans transition-colors duration-400 flex flex-col selection:bg-purple-500 selection:text-white">
      <Header />
        ...
        <div className="container-tech relative z-10 flex justify-center">
          ...
          >
            ...
            <div className="relative glass-dark border border-white/10 p-10 md:p-20 rounded-[3rem] shadow-2xl text-center overflow-hidden group">
              ...
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-purple-500/30 rounded-full blur-2xl group-hover:bg-purple-500/40 transition-colors duration-500 pointer-events-none" />
              <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-fuchsia-500/20 rounded-full blur-2xl pointer-events-none" />
              ...
              <div className="relative mb-10 inline-flex items-center justify-center">
                <motion.div 
                  ...
                  className="absolute inset-0 text-purple-500/20 blur-[2px]"
                >
                  <Cpu size={120} />
                </motion.div>
                <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-purple-500 to-fuchsia-600 flex items-center justify-center shadow-lg shadow-purple-500/50 relative z-10">
                  <HardHat size={40} className="text-white" />
                </div>
                <motion.div 
                  animate={{ scale: [1, 1.2, 1], opacity: [0.5, 1, 0.5] }}
                  transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}
                  className="absolute -bottom-3 -left-3 text-fuchsia-400 z-20"
                >
                  <Sparkles size={28} />
                </motion.div>
              </div>
              ...
              {/* Tombol Kembali */}
              <Link href="/">
                <Button size="lg" className="h-14 px-8 text-base font-bold bg-purple-600 hover:bg-purple-500 border-none text-white shadow-[0_0_20px_rgba(147,51,234,0.4)] hover:shadow-[0_0_30px_rgba(147,51,234,0.6)] hover:scale-105 transition-all rounded-full">
