        ...
        <div className="container-tech relative z-10 flex justify-center">
          ...
          >
            ...
            <div className="relative bg-white/10 dark:bg-slate-900/50 backdrop-blur-xl border border-white/20 dark:border-slate-800 p-10 md:p-16 rounded-[2.5rem] shadow-2xl text-center overflow-hidden group">
              ...
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-amber-500/30 rounded-full blur-2xl group-hover:bg-amber-500/40 transition-colors duration-500" />
              ...
              <div className="relative mb-8 inline-flex items-center justify-center">
                <motion.div 
                  ...
                  className="absolute inset-0 text-amber-500/20 blur-sm"
                >
                  <Settings size={100} />
                </motion.div>
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/50 relative z-10">
              ...
              <h1 className="text-3xl md:text-5xl font-bold font-uii mb-4 text-white drop-shadow-md">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Dalam Perbaikan</span>
              </h1>
              ...
              <p className="text-slate-400 font-medium leading-relaxed mb-10 max-w-lg mx-auto">
                Tim pengembangan kami sedang membangun fitur-fitur baru yang menakjubkan. Halaman <strong className="text-slate-200">Erasmus+ BUiLD</strong> ini akan segera hadir dengan tampilan dan fungsionalitas yang lebih baik. Terima kasih atas kesabaran Anda!
              </p>

              {/* Tombol Kembali */}
              <Link href="/">
                <Button size="lg" className="h-14 px-8 text-base font-bold bg-amber-500 hover:bg-amber-600 text-slate-900 border-none shadow-[0_0_20px_rgba(245,158,11,0.4)] hover:scale-105 transition-transform">
